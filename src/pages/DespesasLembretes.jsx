...
export default function DespesasLembretes() {
  ...
  const handleCriarFornecedor = async (dados) => {
    // Aceita string (cadastro manual) ou objeto { nome, cnpj, nome_fantasia } (via consulta CNPJ)
      ...
      <div className="p-6 max-w-4xl mx-auto">
        ...
        <Tabs value={tipoForm} onValueChange={setTipoForm}>
          ...
          <TabsContent value="lembrete">
            <FormularioLembrete
              editingItem={editingItem && tipoForm === "lembrete" ? editingItem : null}
              formDataLembrete={formDataLembrete}
              setFormDataLembrete={setFormDataLembrete}
              handleSubmitLembrete={handleSubmitLembrete}
              handleValorChange={handleValorChange}
              handleCorrecaoOrtografica={handleCorrecaoOrtografica}
              corrigindoTexto={corrigindoTexto}
              sugestoes={sugestoes}
              enviarTesteWhatsAppLembrete={enviarTesteWhatsAppLembrete}
              enviandoTeste={enviandoTeste}
